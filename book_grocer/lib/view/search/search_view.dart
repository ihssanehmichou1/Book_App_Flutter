...
import '../wishlist/wishlist_manager.dart';
...
class _SearchViewState extends State<SearchView> {
  ...
  void addToCart(Map<String, dynamic> item) {
    Provider.of<CartManager>(context, listen: false).addToCart(item);
    print('Ajouté au panier : ${item['name']}');
  }

  void addToWishlist(Map<String, dynamic> item) {
    Provider.of<WishlistManager>(context, listen: false).addToWishlist(item);
  }
